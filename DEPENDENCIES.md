...
26. `vercor/runtime_contracts.py` - exchange-field flattening and coupler-owned runtime import/export contract construction built on (25)
...
29. `vercor/runtime_driver.py` - per-component runtime dispatch, receive, pure/host step selection, outgoing priming, and host-adapter detection built on (24, 25, 28)
