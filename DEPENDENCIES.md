...
28. `vercor/exchange.py` and `vercor/exchanges.py` - public exchange declarations with canonical `target`/`fields`/`regrid` names, public exchange configuration type aliases, and canonical `*_FIELDS` exchange recipes built on (12, 17, 18, 19)
