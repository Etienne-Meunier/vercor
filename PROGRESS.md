...
- VerCOR 0.4.3 pre-publication release-candidate evidence was refreshed after the README and release-runbook corrections; build verification completed locally (2026-07-25) from exact commit `23643e4637ac767d793fb1b4cb925ba7cf6f3c67`: the 0.4.3 recovery candidate preserves the immutable 0.4.2 publication failure, moves the active release contracts and documentation to 0.4.3, and keeps the workflow version-generic. Focused release contracts passed 30/30, fast 711/711, full 1,349/1,349, and branch coverage was 91.13%. A fresh exactly-two-file candidate build in `/private/tmp/vercor-0.4.3-build.KxQhMu` produced `vercor-0.4.3-py3-none-any.whl`, 213400 B, SHA-256 `54dc9855bf6fc91914656bb491af21ba0d82ecf24abc2e05465e75f8ce2bfd76`; `vercor-0.4.3.tar.gz`, 156952 B, SHA-256 `b5da88f9518320a16cfa66a29ed5d66e9107be2febb8172fa471fa66b5b0ddbc`. No tag, push, publication, upload, release creation, or other remote mutation occurred; Task 5 will amend this candidate entry with hosted-publication evidence.
