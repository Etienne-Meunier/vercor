...
- VerCOR 0.4.3 release-candidate evidence was refreshed after the README and release-runbook corrections (2026-07-25): the 0.4.3 recovery candidate preserves the immutable 0.4.2 publication failure, moves the active release contracts and documentation to 0.4.3, and keeps the workflow version-generic. A fresh exactly-two-file build in `/private/tmp/vercor-0.4.3-build.71p3WH` produced `vercor-0.4.3-py3-none-any.whl`, 213398 B, SHA-256 `1b4f299ed27c0caf29d5d5fb36d51decfb53a2cbd3c9050ed06c3000caa19ad1`; `vercor-0.4.3.tar.gz`, 156952 B, SHA-256 `b5da88f9518320a16cfa66a29ed5d66e9107be2febb8172fa471fa66b5b0ddbc`. No tag, push, publication, upload, release creation, or other remote mutation was performed.
