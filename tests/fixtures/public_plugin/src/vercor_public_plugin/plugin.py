...
class StructuralJaxComponent:
    ...
    def __init__(self) -> None:
        ...
        self.spec = ComponentSpec(
            ...
            lifecycle=LifecycleHooks(initialize=_record_original_component),
    ...
    def step(
        ...
        """Increment temperature once per sequential backend step."""
...
class RecordingTopologyPolicy:
    ...
    def applies(self, context: TopologyContext) -> bool:
        ...
        return tuple(context.components) == ("JAX", "HOST")
...
def run_smoke(output_dir: Path) -> dict[str, object]:
    ...
    coupler = Coupler(
        ...
        components=(jax_component, host_component),
        run_order=(jax_component.name, host_component.name),
    ...
    if temperature != 2.0 or host_value != 14.0:
